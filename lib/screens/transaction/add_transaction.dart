            ...
            return Padding(
              ...
              child: ListView(children: [
                ...
                CustomTextFormField('description', descriptionController,
                    Icon(Icons.description), () {}, () {}, TextInputType.text),
                SizedBox(
                  height: 50,
                ),
                ...
                BlocConsumer<WalletCubit, WalletStates>(
                  ...
                  builder: (context, WalletStates state) {
                    return FlatButton(
                        child: Text('save'),
                        onPressed: () {
                          int c_id = ContactCubit.get(context).getContactId(
                              contactName: contactIdController.text);
                          int e_id = ExchangeCubit.get(context).getExchangeId(
                              exchangeName: exchangeIdController.text);
                          int w_id = WalletCubit.get(context)
